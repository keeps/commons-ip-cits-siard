...
public class SiardConstants {
    ...
    /**
     * Constant specification id "SIARD_1".
     */
    public static final String VALIDATION_REPORT_SPECIFICATION_SIARD_1_ID = "SIARD_1";

    /**
     * Constant specification description for id "SIARD_1".
     */
    public static final String VALIDATION_REPORT_SPECIFICATION_SIARD_1_DESCRIPTION = "There MUST be a minimum of one representation and therefore "
    ...
    /**
     * Constant specification cardinality for id "SIARD_1".
     */
    public static final String VALIDATION_REPORT_SPECIFICATION_SIARD_1_CARDINALITY = "";

    /**
     * Constant specification level for id "SIARD_1".
     */
    public static final String VALIDATION_REPORT_SPECIFICATION_SIARD_1_LEVEL = "MUST";

    /* SIARD_2 */

    /**
     * Constant specification id "SIARD_2".
     */
    public static final String VALIDATION_REPORT_SPECIFICATION_SIARD_2_ID = "SIARD_2";

    /**
     * Constant specification name for id "SIARD_2".
     */
    public static final String VALIDATION_REPORT_SPECIFICATION_SIARD_2_NAME = "Type";

    /**
     * Constant specification location for id "CSIPSTR2".
     */
    public static final String VALIDATION_REPORT_SPECIFICATION_SIARD_2_LOCATION = "mets/@TYPE";

    /**
     * Constant specification description for id "CSIPSTR2".
     */
    public static final String VALIDATION_REPORT_SPECIFICATION_SIARD_2_DESCRIPTION = "For information packages that "
      + "primarily contain relational databases the value in Package mets/@TYPE "
      + " MUST be “Databases” as taken from the CSIP Vocabulary for Content Category.";

    /**
     * Constant specification cardinality for id "CSIPSTR2".
     */
    public static final String VALIDATION_REPORT_SPECIFICATION_SIARD_2_CARDINALITY = "1..1";

    /**
     * Constant specification level for id "CSIPSTR2".
     */
    public static final String VALIDATION_REPORT_SPECIFICATION_SIARD_2_LEVEL = "MUST";
    ...
    public static String getSpecificationName(final String id) {
      if (VALIDATION_REPORT_SPECIFICATION_SIARD_2_ID.equals(id)) {
        return VALIDATION_REPORT_SPECIFICATION_SIARD_2_NAME;
      }
      //if (VALIDATION_REPORT_SPECIFICATION_SIARD_ID.equals(id)) {
    ...
    public static String getSpecificationLocation(final String id) {
      ...
      //}
      if (VALIDATION_REPORT_SPECIFICATION_SIARD_2_ID.equals(id)) {
        return VALIDATION_REPORT_SPECIFICATION_SIARD_2_LOCATION;
      }
      if (VALIDATION_REPORT_SPECIFICATION_CSIPSTR3_ID.equals(id)) {
    ...
    public static String getSpecificationDescription(final String id) {
      if (VALIDATION_REPORT_SPECIFICATION_SIARD_1_ID.equals(id)) {
        return VALIDATION_REPORT_SPECIFICATION_SIARD_1_DESCRIPTION;
      }
      if (VALIDATION_REPORT_SPECIFICATION_SIARD_2_ID.equals(id)) {
        return VALIDATION_REPORT_SPECIFICATION_SIARD_2_DESCRIPTION;
      }
      if (VALIDATION_REPORT_SPECIFICATION_CSIPSTR3_ID.equals(id)) {
    ...
    public static String getSpecificationCardinality(final String id) {
      if (VALIDATION_REPORT_SPECIFICATION_SIARD_1_ID.equals(id)) {
        return VALIDATION_REPORT_SPECIFICATION_SIARD_1_CARDINALITY;
      }
      if (VALIDATION_REPORT_SPECIFICATION_SIARD_2_ID.equals(id)) {
        return VALIDATION_REPORT_SPECIFICATION_SIARD_2_CARDINALITY;
      }
      if (VALIDATION_REPORT_SPECIFICATION_CSIPSTR3_ID.equals(id)) {
    ...
    public static String getSpecificationLevel(final String id) {
      if (VALIDATION_REPORT_SPECIFICATION_SIARD_1_ID.equals(id)) {
        return VALIDATION_REPORT_SPECIFICATION_SIARD_1_LEVEL;
      }
      if (VALIDATION_REPORT_SPECIFICATION_SIARD_2_ID.equals(id)) {
        return VALIDATION_REPORT_SPECIFICATION_SIARD_2_LEVEL;
      }
      if (VALIDATION_REPORT_SPECIFICATION_CSIPSTR3_ID.equals(id)) {
