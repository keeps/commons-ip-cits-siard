...
import static org.roda_project.commons_ip2.cli.model.enums.ReportTypeEnums.ReportType.SIARD;
...
public class Validate implements Callable<Integer> {
  ...
  ReportTypeEnums.ReportType reportType = SIARD;
  ...
  private void handleSipValidation(final String sip, final String reportPathDir,
    final ReportTypeEnums.ReportType reportType, final boolean verbose)
